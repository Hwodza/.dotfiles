...
in
{
		wayland.windowManager.hyprland = {
				...
				extraConfig = ''
						...
						bind = $mainMod SHIFT, L, exec, ${workspace2d} move_right "" ""
						bind = $mainMod SHIFT, K, exec, ${workspace2d} move_up "" ""
						bind = $mainMod SHIFT, J, exec, ${workspace2d} move_down "" ""

						# Apply moves to all monitors
						bind = $mainMod CTRL, H, exec, ${workspace2d} left all ""
						bind = $mainMod CTRL, L, exec, ${workspace2d} right all ""
						bind = $mainMod CTRL, K, exec, ${workspace2d} up all ""
						bind = $mainMod CTRL, J, exec, ${workspace2d} down all ""

						# Sync all monitors
						bind = $mainMod CTRL SHIFT, H, exec, ${workspace2d} left all sync
