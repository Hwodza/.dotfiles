...
keymap('n', '<leader>l', '<cmd>Outline<CR>', { desc = 'Toggle [L]outline' })
keymap('n', '<leader>mp', '<cmd>MarkdownPreview<CR>', { desc = '[M]arkdown [P]review' })
keymap('n', '<leader>c', ':let @+ = expand("%:p")<CR>', {desc = '[C]opy path of current buffer to clipboard'})
